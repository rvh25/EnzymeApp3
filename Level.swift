...
class Level {
    ...
    /*func locaterxns() {
        ...
        for component in substrates {
            if component.row == 0 && component.column == 0 {
                if let enzyme1 = componentAtColumn(component.column, row: component.row + 1) {
                    if hasRxn(component, component2: enzyme1) {
                        set.insert(Swap(componentA: component, componentB: enzyme1))
                    }
                }
                if let enzyme2 = componentAtColumn(component.column + 1, row: component.row) {
                    if hasRxn(component, component2: enzyme2) {
                        set.insert(Swap(componentA: component, componentB: enzyme2))
                    }
                }
            }
            ...
            if component.row == NumRows - 1 && component.column == 0 {
                ...
                if let enzyme3 = componentAtColumn(component.column + 1, row: component.row) {
                    if hasRxn(component, component2: enzyme3) {
                        set.insert(Swap(componentA: component, componentB: enzyme3))
                    }
                }
                ...
                if let enzyme2 = componentAtColumn(component.column, row: component.row - 1) {
                    if hasRxn(component, component2: enzyme2) {
                        set.insert(Swap(componentA: component, componentB: enzyme2))
                    }
                }
                ...
                if let enzyme3 = componentAtColumn(component.column, row: component.row - 1) {
                    if hasRxn(component, component2: enzyme3) {
                        set.insert(Swap(componentA: component, componentB: enzyme3))
                    }
                }
                if let enzyme4 = componentAtColumn(component.column - 1, row: component.row) {
                    if hasRxn(component, component2: enzyme4) {
                        set.insert(Swap(componentA: component, componentB: enzyme4))
                    }
                }
            }
        }
    ...
    func direction() -> (horzDelta: Int, vertDelta: Int) {
